...
import static hhp.tictactoe.simple.smart.positionmatch.Trainer.train;
import static hhp.tictactoe.simple.smart.positionmatch.Utility.humanInput;
import static hhp.tictactoe.simple.smart.positionmatch.Utility.machineLearningInput;
import static hhp.tictactoe.simple.smart.positionmatch.Utility.randomInput;
import static hhp.tictactoe.simple.smart.positionmatch.Utility.turn;
...
public class TicTacToe {
	...
	public static void play(URL gameDataURL, boolean doBackPropagation) throws Exception{
		...
		Classifier classifier = train(gameDataURL);
